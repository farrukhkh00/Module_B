...
const Login = () => {
  ...
  let loginCharIndex = window.location.href.indexOf("login")
  let slicedUrl  = window.location.href.slice(0,loginCharIndex)
  setTimeout(()=>{
    window.location.href = slicedUrl + "Dashboard"
